...
const token = "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJEdkVoZlNMbWtmMC1BZnphS1JTMmhJY2tHa0Jib2dFT3JROVFaQW5tUjZjIn0..TubBRmrXUYwYoQ9wf97Xu4rEKwHgR1tnTyJXUDO8KwbgiaaCRJ3rWC7R_5z7448Ure7Wuwg5ItCoVrR60BjA6kRZszpZ96pyFR9QdO_HOpF2_CozbOZxo3cLqnYh7ljHfdQepED_8tbZI1PSP9mpGeN0wGf5nLGWmoer5hAVEgh-YTbszpFogHJkkpFbSK6LZ9hB66fihPfLXUQsIJT7zXWP1qol770WoyoRxbXXKRXKdbDOxCOdwYfEvX9UgmOpA7xpve-txFuF1zVTbiOcMyf4fzz_Q-tM65OzlBwe6sa_4mpsp0kFW6p3lFjjgbn_hXEH6TEhzkfmIsReWgZpbQ";
const request = {
...
const rate = 50; // Taxa de requisições por rateUnit(m ou s)
const rateUnit = '1s'// Define a taxa de requisições ('1m' para minutos, '1s' para segundos)
const durationValue = 10; // Duração do teste por durationUnit
...
export const options = {
  scenarios: {
    run: {
      ...
      timeUnit: rateUnit,// Define a taxa de requisições por minuto
